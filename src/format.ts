 ...
 * ```
 */
export function formatDiff(fileA: string[], fileB: string[], diffs: Region[]): string {
    let a = 0
    let b = 0
    let d = 0
    const chunks: Array<[updated: boolean, aLo: number, aHi: number, bLo: number, bHi: number]> = []
